...
function AdminDashboard({ currentUser, events, setEvents }) {
  ...
  return (
    <div className="dashboard-container">
      <header className="dashboard-header">
        <h2 className="welcome-text">Welcome, {currentUser?.name || "Admin"}!</h2>
      ...
      <section className="events-section">
        <div className="events-header">
          ...
          <div className="search-add-container">
            ...
            <button className="add-event-btn" onClick={() => navigate("/addevent")}>
              Add Event
            </button>
          </div>
        </div>
